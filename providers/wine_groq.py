...
# Define default models - focusing on Qwen and Llama models available on Groq
DEFAULT_MODELS = [
    "qwen-qwq-32b",
...
# Function to call the Groq API and process the result for a single model
def call_model(model_name, prompt, timeout=30, max_retries=3):
    def _generate():
    ...
    while retries < max_retries:
        ...
        try:
            ...
            variety = future.result(timeout=timeout)
...
def run_provider(models=None):
    """
    Run the Groq provider with specified models or default models.
    Args:
